...
To assess complementarities between China's bilateral diplomatic visits and state sponsored media coverage of developing countries with Beijing's bilateral development finance, we combine data from multiple sources. We merge AidData’s Chinese development finance dataset with two newly available datasets: (1) AidData’s compiled yearly counts of bilateral official diplomatic visits from China and (2) millions of English edition *Xinhua* news articles from 2000 to 2014 scraped by the Cline Center for Advanced Social Research. The full dataset consists of unique recipient-year observations from 2000 to 2014.
