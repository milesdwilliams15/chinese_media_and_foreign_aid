...
Nonetheless, absent transparency in reporting, it has proved difficult to provide direct confirmation that China's foreign aid is motivated by such public goals as south-south diplomacy and international legitimacy. However, newly available datasets offer an opportunity to empirically probe these motives. In this study, we explore the connections between China's bilateral development finance and critical *visible* activities linked to the diplomatic and legitimacy-seeking objectives scholars attribute to China's international development finance. We focus in particular on two factors: (1) diplomatic visits from China to developing countries and (2) coverage of developing countries in external-facing state-run media.
...
First, they signal the importance of developing countries to Beijing. Just like development finance, diplomatic trips and media coverage are subject to scarcity---the first in terms of limited resources and bandwidth; the second in terms of time dedicated to writing, editing, and publishing content. Within the rationalist framework most often adopted by IR scholars who study international aid, this implies a direct correspondence between the countries that host diplomatic visits and that are subjects of state-sponsored news articles and the importance of developing countries to China. In short, visits and coverage are costly, and they therefore tell us something about which developing countries Beijing values most.
