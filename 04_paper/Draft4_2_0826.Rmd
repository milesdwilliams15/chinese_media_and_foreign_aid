...
Alongside this change in Beijing's approach to international development finance, a consensus has evolved that aid and debt serve different functions for China. Aid is supposed to support China's foreign policy goals, while debt is supposed to support its market interests. In short, aid lets Beijing buy influence, whereas debt helps enrich Chinese firms and propel economic growth for China.
