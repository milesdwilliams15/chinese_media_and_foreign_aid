...
Given the diplomatic uses of foreign aid, the enduring obscurity that surrounds Beijing's development finance is all the more puzzling. Unlike Western donors, China does not report its financing activities to an international organization or make its activities visible in an online database. To say transparency is out of character for Beijing is an understatement, but foreign aid is one issue area where transparency would arguably serve China's interests. So why the secrecy?
