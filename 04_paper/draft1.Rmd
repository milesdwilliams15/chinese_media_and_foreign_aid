...
Turning to the estimates of interest, across specifications the coefficients on media coverage in *Xinhua* and the number of diplomatic visits run in the expected direction. Expressed as elasticities, a majority of the estimates suggest that a one percent greater yearly instances of coverage are associated with more than half a percent to over one percent greater aid received by an aid recipient relative to another aid recipient. Further, one percent greater diplomatic visits is related to almost one percent to one and a half percent greater aid to that recipient relative to another.
