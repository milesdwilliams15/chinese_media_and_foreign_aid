...
Our findings paint an interesting picture of how China's overseas financing relates to other kinds of foreign policy activities, speicifically its coverage of aid recipients targeted at foreign audiences and its bilateral diplomatic missions. To the extent that aid is associated with improving Beijing's image and fostering closer ties with recipients, we expect Beijing to complement its aid activities with both more coverage and more diplomatic visits. 

At the same time that we expected to observe these relationships for Chinese aid, we expected to find weaker relationships between these outcomes and Chinese loans. China's application of debt has become a point of controversy because of its proposed links to Beijing's comercial interests. We therefore hypothesized that loans from China would be independent of coverage and visits.

Our finding only partially support our expectations. As expected, aid recipients receive disproportionate coverage in *Xinhua*. However, they are no more likely to receive more diplomatic missions from Beijing. Conversely, while debt owed to China does not lead to more coverage in *Xinhua*, it does correspond with more diplomatic visits. These more complicated findings warrant further explanation and research. At minimum, the links between debt and diplomatic activities suggests that Beijing's commercial interests cannot be divorced entirely from foreign policy. China appears to engage in efforts to build diplomatic ties disproportionately in debtor countries (rather than aid recipients). This finding deserves attention by future scholars to assess possible mechanisms that lead debt and diplomacy to complement each other.
